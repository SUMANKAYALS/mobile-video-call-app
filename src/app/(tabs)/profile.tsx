...
//   { icon: "time-outline", label: "Call History", color: COLORS.accentSecondary },
...
//           <Text className="text-sm font-semibold text-[#FDCB6E]">4 day theory test</Text>
//         </View>
//       </View>
...
//           <Text className="mt-1 text-xs text-foreground-muted">call</Text>
//         </View>
//         <View className="flex-1 items-center rounded-2xl border border-border bg-surface px-4 py-4">
...
//           <Text className="mt-1 text-xs text-foreground-muted">live chat</Text>
//         </View>
//       </View> */}
      ...
      <View className="items-center py-5">
        <View className="mb-3.5 relative">
          ...
          <Pressable
            ...
            className="absolute bottom-0 right-0 h-7 w-7 items-center justify-center rounded-full bg-primary border-2 border-background"
          >
